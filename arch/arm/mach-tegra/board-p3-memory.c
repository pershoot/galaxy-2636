...
static const struct tegra_emc_table p3_emc_tables[] = {
	{
...
static const struct tegra_emc_chip p3_emc_chips[] = {
	{
		...
		.mem_pid = -1,
		.table = p3_emc_tables,
		.table_size = ARRAY_SIZE(p3_emc_tables)
	},
};
...
{
	/* Init P3 emc table. */
	tegra_init_emc(p3_emc_chips,
		ARRAY_SIZE(p3_emc_chips));
