...
/* linux/arch/arm/mach-tegra/board-p4lte-gpioi2c.c
...
/* AD converter */
static struct i2c_gpio_platform_data tegra_gpio_i2c11_rev05_pdata = {
	.sda_pin = GPIO_ADC_I2C_SDA_REV05,
	.scl_pin = GPIO_ADC_I2C_SCL_REV05,
	.udelay = 3, /* 200 kHz */
	.timeout = 0, /* jiffies */
};

static struct platform_device tegra_gpio_i2c11_rev05_device = {
	.name = "i2c-gpio",
	.id = 11,
	.dev = {
		.platform_data = &tegra_gpio_i2c11_rev05_pdata,
	}
};
...
/* HDMI */
static struct i2c_gpio_platform_data tegra_gpio_i2c13_rev05_pdata = {
	.sda_pin = GPIO_HDMI_I2C_SDA,
	.scl_pin = GPIO_HDMI_I2C_SCL,
	.udelay = 3,
	.timeout = 0,
...
static struct platform_device tegra_gpio_i2c13_rev05_device = {
	.name = "i2c-gpio",
	.id = 13,
	.dev = {
		.platform_data = &tegra_gpio_i2c13_rev05_pdata,
	}
};
