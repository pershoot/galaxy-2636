...
/* linux/arch/arm/mach-tegra/board-p4-gpio.c
...
static struct sec_gpio_cfg_st p4_gpio_table[] = {
...
#if !defined(CONFIG_MACH_SAMSUNG_P3_P7100)
	{GPIO,  GPIO_CAM_R_nSTBY,			 GPIO_OUTPUT,	 GPIO_LEVEL_NONE },
#else
	...
	{GPIO,  GPIO_IPC_RXD,			 GPIO_OUTPUT,	 GPIO_INIT_LEVEL_IPC_BACK_POWERING },
        ...
        {GPIO,  GPIO_TDMB_EN,                    GPIO_OUTPUT,    GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_RST,                   GPIO_OUTPUT,    GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_CS,                GPIO_OUTPUT,    GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_CLK,               GPIO_OUTPUT,    GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_MOSI,              GPIO_OUTPUT,    GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_MISO,              GPIO_OUTPUT,    GPIO_LEVEL_LOW },
#elif !defined(CONFIG_MACH_SAMSUNG_P3_P7100)
        {GPIO,  GPIO_TDMB_EN,                    GPIO_INPUT,     GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_RST,                   GPIO_INPUT,     GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_CS,                GPIO_INPUT,     GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_CLK,               GPIO_INPUT,     GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_MOSI,              GPIO_INPUT,     GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_MISO,              GPIO_INPUT,     GPIO_LEVEL_LOW },
#endif
...
/*  {GPIO,  TEGRA_GPIO_PS3,		 GPIO_OUTPUT,	 GPIO_LEVEL_LOW  }, */
	...
	{GPIO,  TEGRA_GPIO_PX2,		 GPIO_INPUT,	 GPIO_LEVEL_LOW  },
	{GPIO,  TEGRA_GPIO_PX3,		 GPIO_INPUT,	 GPIO_LEVEL_LOW  },
	...
	{GPIO,  TEGRA_GPIO_PH7,		 GPIO_INPUT, GPIO_LEVEL_NONE },
        ...
        {GPIO,  TEGRA_GPIO_PP0,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PP1,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PP2,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PP3,          GPIO_INPUT, GPIO_LEVEL_LOW },
/*
        {GPIO,  TEGRA_GPIO_PA2,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PA3,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PA4,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PA5,          GPIO_INPUT, GPIO_LEVEL_LOW },
*/

        {GPIO,  TEGRA_GPIO_PQ0,          GPIO_OUTPUT, GPIO_LEVEL_LOW },
#endif


#if !defined(CONFIG_MACH_SAMSUNG_P4WIFI)
        {GPIO,  TEGRA_GPIO_PT5,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PT6,          GPIO_INPUT, GPIO_LEVEL_LOW },
#endif
...
static struct sec_slp_gpio_cfg_st p4_sleep_gpio_table[] = {
	...
	{NO,	 GPIO_HDMI_EN1, 		 GPIO_OUTPUT,	 GPIO_LDO_ENABLE_GROUP_SLEEP_LEVEL	},
...
#else
	{NO,	 GPIO_CAM_R_nSTBY,			 GPIO_OUTPUT,	 GPIO_LEVEL_LOW  },
#endif
...
#if defined(CONFIG_TDMB) || defined(CONFIG_TDMB_MODULE)
        {YES,  GPIO_TDMB_EN,                            GPIO_OUTPUT,     GPIO_LEVEL_LOW },
        {YES,  GPIO_TDMB_RST,                   GPIO_OUTPUT,     GPIO_LEVEL_LOW },
        {YES,  GPIO_TDMB_SPI_CS,                        GPIO_OUTPUT,     GPIO_LEVEL_LOW },
        {YES,  GPIO_TDMB_SPI_CLK,               GPIO_OUTPUT,     GPIO_LEVEL_LOW },
        {YES,  GPIO_TDMB_SPI_MOSI,              GPIO_OUTPUT,     GPIO_LEVEL_LOW },
        {YES,  GPIO_TDMB_SPI_MISO,              GPIO_OUTPUT,     GPIO_LEVEL_LOW },
#elif !defined(CONFIG_MACH_SAMSUNG_P3_P7100)
        {GPIO,  GPIO_TDMB_EN,                    GPIO_INPUT,     GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_RST,                   GPIO_INPUT,     GPIO_LEVEL_LOW },
        {GPIO,  GPIO_TDMB_SPI_CS,                GPIO_INPUT,     GPIO_LEVEL_LOW },
...
#if defined(CONFIG_MACH_SAMSUNG_P4WIFI)  // hg2395.kim
        {YES,    TEGRA_GPIO_PP0,                 GPIO_INPUT, GPIO_LEVEL_LOW },
        {YES,    TEGRA_GPIO_PP1,                 GPIO_INPUT, GPIO_LEVEL_LOW },
        {YES,    TEGRA_GPIO_PP2,                 GPIO_INPUT, GPIO_LEVEL_LOW },
        {YES,    TEGRA_GPIO_PP3,                 GPIO_INPUT, GPIO_LEVEL_LOW },
        {YES,    TEGRA_GPIO_PQ3,                 GPIO_OUTPUT, GPIO_LEVEL_LOW },
#endif

#if !defined(CONFIG_MACH_SAMSUNG_P4WIFI)
        {GPIO,  TEGRA_GPIO_PT5,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PT6,          GPIO_INPUT, GPIO_LEVEL_LOW },
        {GPIO,  TEGRA_GPIO_PU5,          GPIO_OUTPUT, GPIO_LEVEL_LOW },
#endif
};
