/*
 * arch/arm/mach-tegra/include/mach/gpio-p4.h
 *
 *
...
#define GPIO_AP2LTE_WAKEUP		TEGRA_GPIO_PV0
...
#define GPIO_VIA_PS_HOLD_OFF		TEGRA_GPIO_PN5
#define GPIO_IMA_N_RST		TEGRA_GPIO_PN4
#define GPIO_UART_SEL2		TEGRA_GPIO_PN6
#define GPIO_IMA_BYPASS		TEGRA_GPIO_PZ4
#define GPIO_IMA_SLEEP		TEGRA_GPIO_PW0
#define GPIO_CMC_RST		TEGRA_GPIO_PV7
...
#define GPIO_AP2LTE_STATUS TEGRA_GPIO_PJ6
#define GPIO_HW_REV2		TEGRA_GPIO_PU4
#define GPIO_TFLASH_DETECT  	TEGRA_GPIO_PU5
#define GPIO_USB_SEL1   TEGRA_GPIO_PX1/*P4LTE_rev05*/
#define GPIO_nTHRM_IRQ		TEGRA_GPIO_PU6
#define GPIO_MOTOR_I2C_SCL	TEGRA_GPIO_PBB1
#define GPIO_CAM_PMIC_EN3   TEGRA_GPIO_PR2
#define GPIO_BL_RESET		TEGRA_GPIO_PR3
#define GPIO_CAM_FLASH_EN_REV05     TEGRA_GPIO_PX2 /*P4LTE_rev05*/
#define GPIO_CPLD_JTAG_TCK_REV05  TEGRA_GPIO_PR4 /*P4LTE_rev05*/
#define GPIO_220_PMIC_PWRON		TEGRA_GPIO_PR5
...
#define GPIO_CAM_FLASH_SET	TEGRA_GPIO_PS7  
#define GPIO_CPLD_JTAG_TDI_REV05 	TEGRA_GPIO_PQ0 /*P4LTE_rev05*/
#define GPIO_WLAN_EN		TEGRA_GPIO_PQ2
#define GPIO_CPLD_JTAG_TMS_REV05	TEGRA_GPIO_PQ3 /*P4LTE_rev05*/
#define GPIO_IMA_PWREN		TEGRA_GPIO_PQ4
#define GPIO_LTE2AP_STATUS	TEGRA_GPIO_PQ5
#define GPIO_LTE2AP_WAKEUP  TEGRA_GPIO_PQ6
#define GPIO_FUEL_ALRT		TEGRA_GPIO_PQ7
#define GPIO_LTE_ACTIVE	TEGRA_GPIO_PZ5
#define GPIO_CPLD_JTAG_TDO_REV05	TEGRA_GPIO_PZ5 /*P4LTE_rev05*/
#define GPIO_TA_nCHG		TEGRA_GPIO_PK5
#define GPIO_CP_RST	TEGRA_GPIO_PK6
#define GPIO_LCD_LDO_EN		TEGRA_GPIO_PX0
#define GPIO_USB_SEL1_REV05     TEGRA_GPIO_PU5
#define GPIO_CP_ON_REV05 TEGRA_GPIO_PX1 /*P4LTE_rev05*/
#define GPIO_LCD_EN		TEGRA_GPIO_PX2
#define GPIO_CAM_FLASH_EN		TEGRA_GPIO_PR4 
#define GPIO_CAM_PMIC_EN4	TEGRA_GPIO_PBB4
#define GPIO_MOTOR_I2C_SDA	TEGRA_GPIO_PBB5
...
//#define GPIO_LTE_ACTIVE_05	TEGRA_GPIO_PW2
#define GPIO_DET_3_5		TEGRA_GPIO_PW3
#define GPIO_ADC_I2C_SCL_REV05	TEGRA_GPIO_PA6 /*P4LTE_rev05*/
#define GPIO_ADC_I2C_SDA_REV05 TEGRA_GPIO_PA7/*P4LTE_rev05*/
#define GPIO_HDMI_I2C_SCL_REV05	TEGRA_GPIO_PB7 /*P4LTE_rev05*/
#define GPIO_TA_nCONNECTED_REV05	TEGRA_GPIO_PB6 /*P4LTE_rev05*/
#define GPIO_HDMI_I2C_SDA_REV05 	TEGRA_GPIO_PB5 /*P4LTE_rev05*/
#define GPIO_V_ACCESSORY_5V_REV05 	TEGRA_GPIO_PB4 /*P4LTE_rev05*/
#define GPIO_ADC_I2C_SCL	TEGRA_GPIO_PI7  
#define GPIO_TA_nCONNECTED  	TEGRA_GPIO_PW2  
//#define GPIO_LTE_ACTIVE_REV05	TEGRA_GPIO_PW2 /*P4LTE_rev05*/
#define GPIO_V_ACCESSORY_5V	TEGRA_GPIO_PD1  
#define GPIO_ACC_INT_REV05	TEGRA_GPIO_PD1 /*P4LTE_rev05*/
#define GPIO_CP_ON		TEGRA_GPIO_PD0
#define GPIO_LCD_EN_REV05	TEGRA_GPIO_PD0 /*P4LTE_rev05*/
...
#define GPIO_TOUCH_EN_REV05		TEGRA_GPIO_PJ2 /*P4LTE_rev05*/
#define GPIO_HDMI_LOGIC_I2C_SDA	TEGRA_GPIO_PK3
#define GPIO_AK8975_INT		TEGRA_GPIO_PK4
#define GPIO_ADC_I2C_SDA    	TEGRA_GPIO_PI3
...
#define GPIO_DP_INT_AP		TEGRA_GPIO_PJ7
#define GPIO_HDMI_I2C_SCL		TEGRA_GPIO_PB0
#define GPIO_CPLD_HW_REV0	TEGRA_GPIO_PB0  /*P4LTE_rev05*/
#define GPIO_HW_REV0		TEGRA_GPIO_PB1
#define GPIO_HW_REV1		TEGRA_GPIO_PK7
#define GPIO_HDMI_I2C_SDA   TEGRA_GPIO_PI4
#define GPIO_CPLD_HW_REV1   	TEGRA_GPIO_PI4 /*P4LTE_rev05*/
#define GPIO_CODEC_I2C_SCL 	TEGRA_GPIO_PT5
#define GPIO_CODEC_I2C_SDA	TEGRA_GPIO_PT6


//#define GPIO_LTE_ACTIVE_06	TEGRA_GPIO_PZ5 //rev0.6

#define GPIO_SIM_DETECT		TEGRA_GPIO_PC7

#define GPIO_MHL_INT	TEGRA_GPIO_PU0
#define GPIO_MHL_RST	TEGRA_GPIO_PU1
#define GPIO_HDMI_EN1	TEGRA_GPIO_PU2
#define GPIO_220_PMIC_PWRHOLD_OFF	TEGRA_GPIO_PU3

/* Warning: deprecated definitions. These should be deleted later */
#if 1  
#define GPIO_MLCD_ON		GPIO_LCD_EN
#define GPIO_MLCD_ON_REV05	GPIO_LCD_EN_REV05
#define GPIO_MLCD_ON1		GPIO_LCD_LDO_EN
