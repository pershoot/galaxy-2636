...
static struct regulator_init_data ldo6_data = REGULATOR_SET (ldo6, 3300, OFF);
...
static struct tps6586x_platform_data tps_platform = {
	...
	.subdevs = tps_devs,
	.gpio_base = 0, /*TPS6586X_GPIO_BASE*/
};
...
/*
*  Wakeup Source definition FOR Samsung P5/P7 Board
*  TEGRA_WAKE_GPIO_PS4 : EXT_WAKEUP
*  TEGRA_WAKE_GPIO_PQ6 : IPC_HOST_WAKEUP
*  TEGRA_WAKE_RTC_ALARM : RTC ALARM
*  TEGRA_WAKE_GPIO_PB6 : TA_nCONNECTED
*  TEGRA_WAKE_GPIO_PQ7 : FUEL_ALRT
*/
...
int __init p3_regulator_init(void)
{
	...
	if (system_rev < 6) {
		/* p5 hw rev 0.4 (3g/wifi)*/
		p3_suspend_data.wake_enb |= TEGRA_WAKE_GPIO_PU5;	/* GPIO_GPIO_INT */
		p3_suspend_data.wake_low |= TEGRA_WAKE_GPIO_PU5;	/* GPIO_GPIO_INT */
	}
