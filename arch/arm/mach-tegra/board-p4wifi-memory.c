...
#include "board-p4wifi.h"
#include "tegra2_emc.h"


static const struct tegra_emc_table p4_emc_tables[] = {
	{
...
static const struct tegra_emc_chip p4_emc_chips[] = {
	{
		...
		.mem_pid = -1,
		.table = p4_emc_tables,
		.table_size = ARRAY_SIZE(p4_emc_tables)
	},
};
...
{
	/* Init P3 emc table. */
	tegra_init_emc(p4_emc_chips,
		ARRAY_SIZE(p4_emc_chips));
