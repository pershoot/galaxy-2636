...
// Remove this section that was written for P3
...
#if (defined(CONFIG_MACH_SAMSUNG_VARIATION_TEGRA) && defined(CHECK_CHIP_REV)) || defined(CONFIG_MACH_C1) || defined(CONFIG_MACH_N1)
// Remove this section that was written for P3
//		if(g_chipver == 2) {
...
#endif
#if (defined(WRITE_MACADDR) || defined(CONFIG_MACH_SAMSUNG_P4LTE))
