...
#define WLC_SET_PEAKRATE            316 /* Throttle PHY rate - WLMEDIA_PEAKRATE */
...
#define	WL_SAMPLECOLLECT_T_VERSION	1	/* version of wl_samplecollect_args_t struct */
...
/* Number of rates for each modulation encoding */
...
#define WL_TX_POWER_20UL_MCS0_FIRST	WL_TX_POWER_20UL_S1x1_FIRST
#define WL_TX_POWER_20UL_CDD_FIRST	WL_TX_POWER_20UL_S1x2_FIRST
#define WL_TX_POWER_20UL_MCS1_FIRST	WL_TX_POWER_20UL_S2x2_FIRST
#define WL_TX_POWER_20UL_MCS2_FIRST	WL_TX_POWER_20UL_S3x3_FIRST

#define WL_TX_POWER_RATES		sizeof(struct txpwr_limits)

/* alias to new symbols/name */
#define txppr_t struct txpwr_limits
#define ofdm_40_siso	ofdm_40
#define mcs_20_siso	u20.n.siso
#define mcs_20_cdd	u20.n.cdd
#define mcs_20_stbc	u20.n.stbc
#define mcs_20_mimo	u20.n.sdm
#define mcs_40_siso	u40.n.siso
#define mcs_40_cdd	u40.n.cdd
#define mcs_40_stbc	u40.n.stbc
#define mcs_40_mimo	u40.n.sdm
#define WL_TX_POWER_OFDM_FIRST		WL_TX_POWER_OFDM20_FIRST
#define WL_TX_POWER_OFDM40_SISO_FIRST	WL_TX_POWER_OFDM40_FIRST
...
/* WLMEDIA specific feature support */
...
/* Get averages RSSI, and SNR values */
struct  wl_lq {
	int32 enable;
	int32 rssi[LQ_IDX_LAST];    /* Array to keep min, max, and cummulative rssi values */
	int32 rssicnt;
	int32 snr[LQ_IDX_LAST];     /* Array to keep min, max, avg cummulative snr values */
	uint32 nsamples;            /* total number of samples (for avg calculation) */
	uint8 isvalid;              /* Flag indicating whether data below is valid */
	uint8 version;
}; /* Link Quality */
