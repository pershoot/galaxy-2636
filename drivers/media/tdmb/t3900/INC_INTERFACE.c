...
/* Technical_Report: TR_110620_M380S : [안충희 선임] TDMB채널 변경 반복시 간헐적으로 방송 수신 안됨 (반영) 110620 : 안충희 선임 */
struct mutex  tdmb_mutex;
#define INC_MUTEX_INIT()        mutex_init(&tdmb_mutex)
...
/*********************************************************************************/
#if defined(CONFIG_MACH_SAMSUNG_P4WIFI) || defined(CONFIG_MACH_SAMSUNG_P4)
PLL_MODE                        m_ucPLL_Mode            = INPUT_CLOCK_19200KHZ;
#else /* CONFIG_MACH_SAMSUNG_P5 */
