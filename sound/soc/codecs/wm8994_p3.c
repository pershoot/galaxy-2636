/*
 * wm8994_p3.c  --  WM8994 ALSA Soc Audio driver related Aries
 *
 ...
 * Debug Feature
 */
#define SUBJECT "wm8994_p3.c"

#define CONFIG_SND_SOC_P4_AUDIO_CHN 1 //jm.choi_2011.05.30 add for audio tuning 
...
struct gain_info_t playback_gain_table[PLAYBACK_GAIN_NUM] = {
	{ /* COMMON */
		...
		.gain = 0x06 << WM8994_SPKOUTL_BOOST_SHIFT  /* +9dB */
	}, {
		.mode = PLAYBACK_SPK,
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTR_BOOST_MASK,
		.gain = 0x06 << WM8994_SPKOUTR_BOOST_SHIFT	/* +9dB */
	}, {
		.mode = PLAYBACK_SPK,
		.reg  = WM8994_AIF1_DAC1_LEFT_VOLUME,	/* 402h */
		.mask = WM8994_AIF1DAC1L_VOL_MASK,
		...
		.reg  = WM8994_LEFT_OUTPUT_VOLUME,  /* 1Ch */
		.mask = WM8994_HPOUT1L_VOL_MASK,
		.gain = WM8994_HPOUT1_VU | 0x30   /* -9dB */
	}, {
		.mode = PLAYBACK_HP_NO_MIC,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME, /* 1Dh */
		.mask = WM8994_HPOUT1R_VOL_MASK,
...
struct gain_info_t voicecall_gain_table[VOICECALL_GAIN_NUM] = {
	{ /* COMMON */
		...
		.reg  = WM8994_SPEAKER_VOLUME_RIGHT,	/* 27h */
		.mask = WM8994_SPKOUTR_VOL_MASK,
		.gain = WM8994_SPKOUT_VU | 0x3C    /* Right Speaker +3dB */
	}, {
		.mode = VOICECALL_SPK,
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTL_BOOST_MASK,
		...
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTR_BOOST_MASK,
		.gain = 0x7 << WM8994_SPKOUTR_BOOST_SHIFT /* Left spaker +12dB */
...
struct gain_info_t voipcall_gain_table[VOIPCALL_GAIN_NUM] = {
	{ /* SPK */
		...
		.mask = WM8994_SPKMIXR_VOL_MASK,
		.gain = 0x0
#if defined(CONFIG_SND_SOC_P4_AUDIO_CHN) //jm.choi_2011.06.07 add for audio tuning 
	}, {
		.mode = VOIPCALL_SPK,
		.reg  = WM8994_SPEAKER_VOLUME_LEFT,	/* 26h */
		.mask = WM8994_SPKOUTL_VOL_MASK,
		...
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTL_BOOST_MASK,
		.gain = 0x02 << WM8994_SPKOUTL_BOOST_SHIFT
	}, {
		.mode = VOIPCALL_SPK,
		.reg  = WM8994_CLASSD,			/* 25h */
		.mask = WM8994_SPKOUTR_BOOST_MASK,
		.gain = 0x02 << WM8994_SPKOUTR_BOOST_SHIFT
	}, {
		.mode = VOIPCALL_SPK,
		.reg  = WM8994_AIF1_DAC1_LEFT_VOLUME,	/* 402h */
		.mask = WM8994_AIF1DAC1L_VOL_MASK,
		.gain = WM8994_AIF1DAC1_VU | 0xEC
	}, {
		.mode = VOIPCALL_SPK,
		.reg  = WM8994_AIF1_DAC1_RIGHT_VOLUME,	/* 403h */
		.mask = WM8994_AIF1DAC1R_VOL_MASK,
		...
		.reg  = WM8994_LEFT_LINE_INPUT_1_2_VOLUME,	/* 18h */
		.mask = WM8994_IN1L_VOL_MASK,
		.gain = WM8994_IN1L_VU | 0x09
	}, {
		.mode = VOIPCALL_MAINMIC,
		.reg  = WM8994_INPUT_MIXER_3,		/* 29h */
		.mask = WM8994_MIXOUTL_MIXINL_VOL_MASK,
		.gain = 0x30                /* +30dB */
	}, {
		.mode = VOIPCALL_MAINMIC,
		.reg  = WM8994_AIF1_ADC1_LEFT_VOLUME,	/* 400h */
		.mask = WM8994_AIF1ADC1L_VOL_MASK,
		.gain = WM8994_AIF1ADC1_VU | 0xCE       /* 0dB */
	}, {
		.mode = VOIPCALL_MAINMIC,
		.reg  = WM8994_AIF1_ADC1_RIGHT_VOLUME,	/* 401h */
		.mask = WM8994_AIF1ADC1R_VOL_MASK,
		...
		.mode = VOIPCALL_MAINMIC,
		.reg  = WM8994_AIF1_ADC1_FILTERS,		/* 410h */
		.mask = WM8994_AIF1ADC1R_HPF_MASK,
		.gain = 0x5800       
	}, { /* HP_MIC */
		.mode = VOIPCALL_HPMIC,
		.reg  = WM8994_RIGHT_LINE_INPUT_1_2_VOLUME,	/* 1Ah */
		.mask = WM8994_IN1R_VOL_MASK,
		.gain = WM8994_IN1R_VU | 0x09
	}, {
		.mode = VOIPCALL_HPMIC,
		.reg  = WM8994_INPUT_MIXER_4,		/* 2Ah */
		.mask = WM8994_MIXOUTR_MIXINR_VOL_MASK,
		.gain = 0x30
	}, {
		.mode = VOIPCALL_HPMIC,
		.reg  = WM8994_AIF1_ADC1_LEFT_VOLUME,	/* 400h */
...
#if defined(CONFIG_SND_SOC_P4_AUDIO_CHN) //jm.choi_2011.05.30 add for audio tuning 
	{  /* HP_OTHER */
...
struct gain_info_t gain_code_table[GAIN_CODE_NUM] = {
	...
	{/* HP */
		...
		.reg  = WM8994_LEFT_OUTPUT_VOLUME,	/* 1Ch */
		.mask = WM8994_HPOUT1L_VOL_MASK,
		.gain = WM8994_HPOUT1_VU | 0x2B		/* -14dB */
	}, {
		.mode = PLAYBACK_HP | PLAYBACK_MODE | GAIN_DIVISION_BIT,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME,	/* 1Dh */
		.mask = WM8994_HPOUT1R_VOL_MASK,
		...
		.reg  = WM8994_LEFT_OUTPUT_VOLUME,	/* 1Ch */
		.mask = WM8994_HPOUT1L_VOL_MASK,
		.gain = WM8994_HPOUT1_VU | 0x35		/* -5dB */
	}, {
		.mode = VOICECALL_HP | VOICECALL_MODE | GAIN_DIVISION_BIT,
		.reg  = WM8994_RIGHT_OUTPUT_VOLUME,	/* 1Dh */
		.mask = WM8994_HPOUT1R_VOL_MASK,
...
void wm8994_register_dump(struct snd_soc_codec *codec)
{
	...
	for (wm8994_register = 0; wm8994_register <= 0x6; wm8994_register++)
		DEBUG_LOG_DUMP(REGPRINTFORM, wm8994_register, wm8994_read(codec, wm8994_register));
...
void wm8994_filter_SPK(struct snd_soc_codec *codec)
{
	...
	/*AIF1DAC1EQ*/
	wm8994_write(codec, 0x480, 0x18);
	wm8994_write(codec, 0x481, 0x62C0);
	wm8994_write(codec, 0x482, 0x0fc6);
	wm8994_write(codec, 0x483, 0x03ff);
	wm8994_write(codec, 0x484, 0x00e8);
	wm8994_write(codec, 0x485, 0x1f8c);
	wm8994_write(codec, 0x486, 0xf073);
	wm8994_write(codec, 0x487, 0x040b);
...
void wm8994_filter_VOIP(struct snd_soc_codec *codec)
{
	...
	/*AIF1DRC1*/
	wm8994_write(codec, 0x440, 0x019c); /* AIF1DAC1 Enable */
#if defined(CONFIG_SND_SOC_P4_AUDIO_CHN) //jm.choi_2011.06.07 add for audio tuning 
	wm8994_write(codec, 0x441, 0x0653);
	wm8994_write(codec, 0x442, 0x0858);
	wm8994_write(codec, 0x443, 0x0438);
	wm8994_write(codec, 0x444, 0x000a);
#else
	wm8994_write(codec, 0x441, 0x0650);
	wm8994_write(codec, 0x442, 0x0851);
	wm8994_write(codec, 0x443, 0x028c);
	wm8994_write(codec, 0x444, 0x000a);
#endif
	...
	wm8994_write(codec, 0x487, 0x040b);
	wm8994_write(codec, 0x488, 0x01c8);
	wm8994_write(codec, 0x489, 0x1c58);
...
void wm8994_disable_path(struct snd_soc_codec *codec)
{
	...
	case HP_NO_MIC:
		...
		/* Remove - This code may cause sound blocking through HP */
...
*/
	...
	if (wm8994->voip_call_active)
		wm8994_write(codec, WM8994_AIF1_ADC1_FILTERS, 0x5800);
#endif
	...
	if(wm8994->loopback_path_control == ear)
	{
		...
		wm8994_write(codec, WM8994_RIGHT_LINE_INPUT_1_2_VOLUME, WM8994_IN1R_VU | 0x05);
		#else
		wm8994_write(codec, WM8994_RIGHT_LINE_INPUT_1_2_VOLUME, WM8994_IN1R_VU | 0x0E);
		#endif
		#else
		wm8994_write(codec, WM8994_RIGHT_LINE_INPUT_1_2_VOLUME, WM8994_IN1R_VU | 0x0E); /* adjust Loopback Ear-Mic Gain for AC level in factory test*/
		#endif
...
void wm8994_record_main_mic(struct snd_soc_codec *codec)
{
	...
	if (wm8994->loopback_path_control == spk || wm8994->loopback_path_control == ear_pmic) 
	{
		val = wm8994_read(codec, WM8994_AIF1_CONTROL_1);
		val &= ~(WM8994_AIF1ADCL_SRC_MASK | WM8994_AIF1ADCR_SRC_MASK);
		wm8994_write(codec, WM8994_AIF1_CONTROL_1, val);
...
//=========================================================		
// it is for preventing howling   : reducing the gain of mic
// 2011.04.25 by Kyumin KIM, Rami Jung

		/* Input Gain */
		val = wm8994_read(codec, WM8994_LEFT_LINE_INPUT_1_2_VOLUME);
		val &= ~(WM8994_IN1L_VOL_MASK );

		//val |= (WM8994_IN1_VU |0x17);
		val |= (0x0100 |0x17);
		...
		//val |= (WM8994_IN1L_MIXINL_VOL); // +30 dB
		wm8994_write(codec, WM8994_INPUT_MIXER_3, val);
//=========================================================
...
void wm8994_set_playback_headset(struct snd_soc_codec *codec)
{
	...
	if (!wm8994->dc_servo[DCS_MEDIA]) {
		...
		testlow1 = ((signed short)(testlow-6)) & 0x00ff;
		testhigh1 = (((signed short)(testhigh-6)<<8) & 0xff00);
...
void wm8994_set_playback_speaker(struct snd_soc_codec *codec)
{
	...
	{
	    val |= (WM8994_BIAS_ENA | WM8994_VMID_SEL_NORMAL | WM8994_SPKOUTR_ENA);
	}
	else
	{
    	val |= (WM8994_BIAS_ENA | WM8994_VMID_SEL_NORMAL |
...
void wm8994_set_playback_speaker_headset(struct snd_soc_codec *codec)
{
	...
	val &= ~(WM8994_MIXOUTLVOL_ENA_MASK | WM8994_MIXOUTRVOL_ENA_MASK |
		WM8994_MIXOUTL_ENA_MASK | WM8994_MIXOUTR_ENA_MASK |
		WM8994_SPKLVOL_ENA_MASK | WM8994_SPKRVOL_ENA_MASK);
	val |= (WM8994_MIXOUTL_ENA | WM8994_MIXOUTR_ENA | WM8994_SPKLVOL_ENA | WM8994_SPKRVOL_ENA);
	wm8994_write(codec, WM8994_POWER_MANAGEMENT_3, val);
	...
	if (!wm8994->dc_servo[DCS_SPK_HP]) {
		...
		ncompensationresultlow = ((signed short)nservo4low - 6)
			& 0x00ff;
		ncompensationresulthigh = ((signed short)(nservo4high - 6)<<8)
			& 0xff00;
...
void wm8994_set_playback_bluetooth(struct snd_soc_codec *codec)
{
	...
	if (wm8994->voip_call_active) {
		...
		/* Rx Gain setting */
		wm8994_write(codec, WM8994_AIF2_ADC_LEFT_VOLUME, 0x1b0);
	}
#endif
...
void wm8994_set_voicecall_speaker(struct snd_soc_codec *codec)
{
	...
	wm8994_write(codec, WM8994_POWER_MANAGEMENT_1,
		WM8994_SPKOUTL_ENA | WM8994_SPKOUTR_ENA | WM8994_VMID_SEL_NORMAL | WM8994_BIAS_ENA);
...
int wm8994_set_codec_gain(struct snd_soc_codec *codec, u32 mode, u16 device)
{
	...
	if (mode == PLAYBACK_MODE &&
			(device == PLAYBACK_SPK || device == PLAYBACK_RING_SPK || device == PLAYBACK_SPK_HP))
		wm8994_filter_SPK(codec);
	else if (mode == RECORDING_MODE &&
			(device == RECORDING_CAM_MAIN || device == RECORDING_MAIN))
