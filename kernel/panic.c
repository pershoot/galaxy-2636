...
/*
 * p5 require ldo4 on before reset
 */
extern int p5_panic_notifier_call(void);
extern void tegra_dvfs_disable_core_cpu(void);
bool have_met_panic = false;
#endif
...
NORET_TYPE void panic(const char * fmt, ...)
{
	 ...
	 * p5 require ldo4 on before reset
	 */
	p5_panic_notifier_call();

	tegra_dvfs_disable_core_cpu();
#endif /* defined(CONFIG_MACH_SAMSUNG_P5) */
